...
export default class TextController {
  ...
  private _canvas_mouseWheelHandler: (e: MouseEvent) => void;
  ...
  constructor(textEditor: TextEditor, canvas: HTMLCanvasElement) {
    ...
    this._canvas_mouseDownHandler = (e: MouseEvent) => {
      this.canvas_mouseDown(e);
    };
    this._canvas_mouseWheelHandler = (e: MouseEvent) => {
      this.canvas_mouseWheel(e);
    };
    this._canvas_touchStartHandler = (e: TouchEvent) => {
      this.canvas_touchStart(e);
    };
    this._canvas_focusHandler = (e: FocusEvent) => {
      this.canvas_focus(e);
    };
    this._window_mouseUpHandler = (e: MouseEvent) => {
      this.window_mouseUp(e);
    };
    this._window_mouseMoveHandler = (e: MouseEvent) => {
      this.window_mouseMove(e);
    };
    this._canvas_touchEndHandler = (e: TouchEvent) => {
      this.canvas_touchEnd(e);
    };
    this._canvas_touchMoveHandler = (e: TouchEvent) => {
      this.canvas_touchMove(e);
    };
    this._textArea_keyUpHandler = (e: KeyboardEvent) => {
      this.textArea_keyUp(e);
    };
    this._textArea_keyDownHandler = (e: KeyboardEvent) => {
      this.textArea_keyDown(e);
    };
    this._textArea_keyPressHandler = (e: KeyboardEvent) => {
      this.textArea_keyPress(e);
    };
    this._textArea_focusHandler = (e: FocusEvent) => {
      this.textArea_focus(e);
    };
    this._textArea_blurHandler = (e: FocusEvent) => {
      this.textArea_blur(e);
    };
    this._textArea_cutHandler = (e: DragEvent) => {
      this.textArea_cut(e);
    };
    this._textArea_copyHandler = (e: DragEvent) => {
      this.textArea_copy(e);
    };
    this._textArea_pasteHandler = (e: DragEvent) => {
      this.textArea_paste(e);
    };
    this._textArea_beforeCutHandler = (e: DragEvent) => {
      this.textArea_beforeCut(e);
    };
    this._textArea_beforeCopyHandler = (e: DragEvent) => {
      this.textArea_beforeCopy(e);
    };
  ...
  private canvas_mouseWheel(e: MouseEvent) {
    e.preventDefault();
